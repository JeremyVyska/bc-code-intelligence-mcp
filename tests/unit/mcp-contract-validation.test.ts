...
describe("MCP Tool Contract Validation", () => {
  ...
  beforeAll(async () => {
    ...
    mockServices = {
      knowledgeService: {
        ...
        askSpecialist: vi
          .fn()
          .mockResolvedValue({ specialist: "test", response: "mock response" }),
    ...
    it("should validate workflow_type enums match service capabilities", async () => {
      ...
      if (schema?.properties?.workflow_type?.enum) {
        ...
        const serviceWorkflowTypes =
          mockServices.workflowService.getWorkflowTypes();
  ...
  describe("Error Handling", () => {
    ...
    it("should handle service errors gracefully", async () => {
      ...
      mockServices.knowledgeService.searchTopics.mockRejectedValueOnce(
