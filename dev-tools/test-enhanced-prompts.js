...
/**
 * Test script for workflow specialist routing
 */

import { WorkflowSpecialistRouter } from '../dist/services/workflow-specialist-router.js';
...
async function testEnhancedPrompts() {
  ...
  try {
    ...
    const workflowSpecialistRouter = new WorkflowSpecialistRouter(
      discoveryService,
      sessionManager,
      workflowService
    );
...
Let's begin with the analysis phase...`;
      ...
      const enhanced = await workflowSpecialistRouter.enhanceWorkflowPrompt(
